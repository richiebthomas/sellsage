...
public class ProductPage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        deleteButton.setBackground(new Color(0X05386B));
        deleteButton.setForeground(new Color(0XEDF5E1));
...
.addContainerGap(130, Short.MAX_VALUE))
        ...
        jSeparator1.setBackground(new Color(0X8EE4AF));
    ...
    if (selectedRow == -1) {
        ...
        String productCode = (String) productTable.getValueAt(selectedRow, 0); // Assuming product code is in the first column
        int confirmDialog = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete this product?", "Confirm Delete", JOptionPane.YES_NO_OPTION);
        
        if (confirmDialog == JOptionPane.YES_OPTION) {
            ProductDAO productDAO = new ProductDAO();
            productDAO.deleteProductDAO(productCode); // Call the delete method with the selected product code
            loadDataSet(); // Reload the product table after deletion
        }
    }
}
