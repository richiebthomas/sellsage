...
class ProductDTO {
    ...
    public int getdaQuantity(String productCode) {
        return quantity;
    }
...
public class ProductDAO {
    ...
    public void editPurchaseStock(String code, int quantity) {
        try {
            String query = "SELECT quantity FROM currentstock WHERE productcode='" +code+ "'";
            resultSet = statement.executeQuery(query);
            if(resultSet.next()) {
 ...
 public int getdaQuantity(String productCode) {
    ...
    try {
        ...
        System.out.println("Query executed for product code: " + productCode);

        if (resultSet.next()) {
            System.out.println("Row found for product code: " + productCode);
            availableQuantity = resultSet.getInt("quantity");
        } else {
            System.out.println("No row found for product code: " + productCode);
        }
    } catch (SQLException e) {
        e.printStackTrace();
